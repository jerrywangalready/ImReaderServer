...
<head>
    ...
    %>
    <title>imReaderServer</title>
    <link href="<%=path%>/comm/image/logo_mini_32.ico" rel="shortcut icon" />
    <link href="<%=path%>/imReaderServer/login/css/login.css" rel="stylesheet" />
    ...
    <script type="text/javascript" src="<%=path%>/imReaderServer/login/js/login.js"></script>
</head>
<body>
    <img id="logo" src="<%=path%>/comm/image/imReaderServer.png">
