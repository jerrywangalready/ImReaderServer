<%@ page import="com.jerrywang.imReaderServer.login.model.UserToken" %><%--
...
<link rel="stylesheet" type="text/css" href="<%=path%>/imReaderServer/index/css/index.css" />
<link rel="stylesheet" type="text/css" href="<%=path%>/imReaderServer/index/css/_style.css" />
<link rel="stylesheet" type="text/css" href="<%=path%>/imReaderServer/index/css/_mobile.css" />
<link rel="stylesheet" type="text/css" href="<%=path%>/imReaderServer/index/css/primary-blue.css" />
...
<!--[if lt IE 9]>
<link rel="stylesheet" href="<%=path%>/imReaderServer/index/css/IE.css"/>
<script src="http//html5shiv.googlecode.com/svn/trunk/html5.js"></script>
<![endif]-->
<!--[if lte IE 8]>
<script type="text/javascript" src="<%=path%>/imReaderServer/index/js/IE.js"></script>
<![endif]-->
<!-- 外部插件 -->
